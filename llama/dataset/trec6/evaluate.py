...
if __name__ == '__main__':
    reference_file = "./dataset/trec6/label.json"  # Replace with your actual reference file
    output_file = "./dataset/trec6/output.json"  # Replace with your actual output file
